...
package com.srti.gbb.navigator;
 ...
 * @author Angie
 */
public class ScreensNavigator  extends StackPane {
    ...
    public boolean loadScreen(String name, String resource) {
        try {
            FXMLLoader myLoader = new FXMLLoader(getClass().getResource(resource),rb);
    ...
    public boolean navigateTo(final String name) {       
